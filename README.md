...
13. **Try Other Models:** There has been several improvements over CLIP. From [OpenCLIP](https://github.com/mlfoundations/open_clip), a community trained CLIP with more improved models; [SigLip](https://github.com/google-research/big_vision); or change the approach to image-captioning models which might capture more nuanced image details than contrastive-learning approaches.
