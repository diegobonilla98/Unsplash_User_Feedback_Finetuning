...
def load_embeddings(image_paths, model, preprocess, device, batch_size=64, embeddings_file="embeddings_clip_baseline.npy"):
    """
...
def find_and_show_closest_images(text_embedding, image_embeddings, image_paths, top_n=25, result_image_path="clip_baseline_top_25_retrieval.png"):
    """
