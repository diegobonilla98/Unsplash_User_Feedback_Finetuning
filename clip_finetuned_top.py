...
def load_embeddings(image_paths, model, preprocess, device, batch_size=64, embeddings_file="embeddings_clip_finetune_user_keywords.npy"):
    """
...
def find_and_show_closest_images(text_embedding, image_embeddings, image_paths, top_n=25, result_image_path="clip_finetune_user_keywords_top_25_retrieval.png"):
    """
...
if __name__ == "__main__":
    ...
    model, preprocess, device = load_model_and_device("clip_user_keywords_finetuned.pth")
